            ...
            <table class="table table-striped">
                ...
                <tr class="text-center">
                    <td class="text-center" colspan="3">
                        <a class="btn btn-outline-success" href="/manager/member/update/${memberDTO.id}">수정하기</a>
                ...
                <tr>
                    <td colspan="3" class="text-center">
                        <a class="btn btn-outline-secondary" href="/manager/member/showAll">목록으로</a>
                    </td>
                </tr>
            </table>
        </div>
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.fire({
                    ...
                    location.href = '/manager/member/delete/' + id;
                })
            }
        });
    }
